...
namespace tinySTL {
	...
	uninitalized_copy(InputIterator first, InputIterator last, ForwardIterator result) {
		__uninitialize_copy(first, last, result, value_type(first));
	}

	template <class InputIterator, class ForwardIterator, class T>
	inline ForwardIterator 
	__uninitalized_copy(InputIterator first, InputIterator last, ForwardIterator result, T*) {
		typedef typename __type_traits<T>::is_POD_type POD_type;
		__uninitialize_copy_aux(first, last, result, POD_type());
	}

	template <class InputIterator, class ForwardIterator>
	inline ForwardIterator 
	__uninitalized_copy_aux(InputIterator first, InputIterator last, ForwardIterator result, __true_type) {
	...
	template <class InputIterator, class ForwardIterator>
	inline ForwardIterator 
	__uninitalized_copy_aux(InputIterator first, InputIterator last, ForwardIterator result, __false_type) {
		while (first < last) {
